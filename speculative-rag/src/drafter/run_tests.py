...
MODEL_MISTRAL_INSTRUCT = os.getenv("DRAFTER_MODEL_PATH", "mistralai/Mistral-7B-Instruct-v0.1")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--run", choices=list(RUN_MAP.keys()), default="test", help="Which experiment to run"
    )
