...
def main(
    ...
    profile_run: bool = typer.Option(False, help="PyTorch Profiler"),
    profile_sample_index: int = typer.Option(
        int(os.getenv("PROFILE_SAMPLE_INDEX", "75")), help="0-based question index to profile"
    ),
    ...
    for q_idx, record in enumerate(records):
        ...
        should_profile_hf = profile_run and (q_idx == profile_sample_index) and not use_vllm
